...
import { purpleC, grayC, blackC, whiteC, greenC, redC, orangeC } from '../files/Colors';
...
interface InfoBoardProps {
  title: string;
  info: string;
  infoTwo: string; // Define the type for infoTwo
}

const InfoBoard: React.FC<InfoBoardProps> = ({ title, info, infoTwo }) => {
